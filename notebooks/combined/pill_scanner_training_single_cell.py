...
seed_names = ['atorvastatin', 'levothyroxine', 'metformin', 'lisinopril', 'amlodipine', 'metoprolol tartrate', 'metoprolol succinate ER', 'albuterol', 'omeprazole', 'losartan', 'gabapentin', 'hydrochlorothiazide', 'sertraline', 'simvastatin', 'escitalopram', 'rosuvastatin', 'bupropion', 'furosemide', 'pantoprazole', 'trazodone', 'fluticasone propionate nasal', 'duloxetine', 'tamsulosin', 'prednisone', 'amoxicillin', 'alprazolam', 'citalopram', 'meloxicam', 'clopidogrel', 'azithromycin', 'warfarin', 'cyclobenzaprine', 'carvedilol', 'venlafaxine ER', 'insulin glargine', 'montelukast', 'pravastatin', 'hydrocodone/acetaminophen', 'tramadol', 'potassium chloride ER', 'lorazepam', 'clonazepam', 'cholecalciferol (vitamin D3) high-dose', 'spironolactone', 'allopurinol', 'amitriptyline', 'buspirone', 'famotidine', 'zolpidem', 'atenolol', 'diazepam', 'glipizide', 'ezetimibe', 'doxycycline hyclate', 'cephalexin', 'ciprofloxacin', 'levofloxacin', 'clindamycin', 'fluoxetine', 'paroxetine', 'quetiapine', 'risperidone', 'aripiprazole', 'olanzapine', 'lamotrigine', 'levetiracetam', 'topiramate', 'divalproex sodium ER', 'phenytoin', 'carbamazepine', 'oxycodone', 'oxycodone/acetaminophen', 'morphine sulfate ER', 'methylphenidate', 'amphetamine/dextroamphetamine', 'lisdexamfetamine', 'atomoxetine', 'sildenafil', 'tadalafil', 'finasteride', 'metronidazole', 'sulfamethoxazole/trimethoprim', 'nitrofurantoin', 'valacyclovir', 'acyclovir', 'prednisolone', 'methylprednisolone dose pack', 'budesonide', 'tiotropium', 'cetirizine', 'loratadine', 'fexofenadine', 'diphenhydramine', 'promethazine', 'ondansetron', 'metoclopramide', 'docusate sodium', 'polyethylene glycol 3350', 'lactulose', 'hydralazine', 'clonidine', 'diltiazem ER', 'verapamil ER', 'nifedipine ER', 'digoxin', 'apixaban', 'rivaroxaban', 'dabigatran', 'cyanocobalamin (vitamin B12)', 'folic acid', 'ferrous sulfate', 'calcium acetate', 'sevelamer', 'sitagliptin', 'glimepiride', 'pioglitazone', 'empagliflozin', 'dapagliflozin', 'liraglutide', 'semaglutide oral', 'tirzepatide', 'mirtazapine', 'desvenlafaxine', 'vortioxetine', 'buprenorphine/naloxone', 'naltrexone', 'disulfiram', 'propranolol', 'labetalol', 'sotalol', 'amiodarone', 'isosorbide mononitrate', 'nitroglycerin SL', 'colchicine', 'febuxostat', 'methotrexate', 'hydroxychloroquine', 'prednisone dose pack', 'dexamethasone', 'triamcinolone', 'azelastine', 'mometasone', 'benzonatate', 'guaifenesin with codeine', 'lidocaine patch', 'gabapentin ER', 'pregabalin', 'baclofen', 'tizanidine', 'methocarbamol', 'metoprolol', 'semaglutide', 'dextroamphetamine/dextroamphetamine saccharate/amphetamine/amphetamine aspartate', 'fluticasone', 'acetaminophen/hydrocodone', 'ibuprofen', 'venlafaxine', 'potassium chloride', 'hydroxyzine', 'ergocalciferol', 'estradiol', 'aspirin', 'cholecalciferol', 'valsartan', 'diclofenac', 'insulin lispro', 'ethinyl estradiol/norethindrone', 'latanoprost', 'doxycycline', 'amoxicillin/clavulanate', 'dulaglutide', 'hydrochlorothiazide/lisinopril', 'fluticasone/salmeterol', 'insulin aspart', 'celecoxib', 'alendronate', 'acetaminophen/oxycodone', 'hydrochlorothiazide/losartan', 'olmesartan', 'testosterone', 'fenofibrate', 'budesonide/formoterol', 'ethinyl estradiol/norgestimate', 'fluticasone/umeclidinium/vilanterol', 'acetaminophen', 'diltiazem', 'thyroid', 'naproxen', 'sumatriptan', 'esomeprazole', 'norethindrone', 'nifedipine', 'progesterone', 'insulin degludec', 'cyanocobalamin', 'adalimumab', 'chlorthalidone', 'oxybutynin', 'ketoconazole', 'irbesartan', 'isosorbide', 'methylprednisolone', 'hydrochlorothiazide/triamterene', 'levocetirizine', 'dexmethylphenidate', 'donepezil', 'ropinirole', 'clobetasol', 'fluticasone/vilanterol', 'albuterol/ipratropium', 'phentermine', 'ofloxacin', 'mupirocin', 'verapamil', 'prazosin', 'ethinyl estradiol/levonorgestrel', 'evolocumab', 'mesalamine', 'memantine', 'ethinyl estradiol/etonogestrel', 'lithium', 'nortriptyline', 'timolol', 'cefdinir', 'magnesium salts', 'meclizine', 'cyclosporine', 'fluconazole', 'rimegepant', 'tretinoin', 'lovastatin', 'drospirenone/ethinyl estradiol', 'docusate', 'temazepam', 'benazepril', 'brimonidine', 'sacubitril/valsartan', 'valproate', 'nebivolol', 'morphine', 'doxazosin', 'amlodipine/benazepril', 'nirmatrelvir/ritonavir', 'emtricitabine/tenofovir', 'tacrolimus', 'dupilumab', 'enalapril', 'anastrozole', 'melatonin', 'torsemide', 'nitroglycerin', 'ketorolac', 'flecainide', 'liothyronine', 'telmisartan', 'lansoprazole', 'insulin human/insulin isophane human', 'oxcarbazepine', 'dicyclomine', 'calcium', 'minoxidil', 'linaclotide', 'rizatriptan', 'oseltamivir', 'nystatin', 'dorzolamide/timolol', 'budesonide/glycopyrrolate/formoterol', 'terazosin', 'dexlansoprazole', 'acetaminophen/codeine', 'erythromycin', 'dorzolamide', 'hydrocortisone', 'bisoprolol', 'solifenacin', 'betamethasone/clotrimazole', 'dextroamphetamine', 'omega-3-acid ethyl esters', 'epinephrine', 'dextromethorphan/promethazine', 'ramipril', 'loperamide', 'mirabegron', 'medroxyprogesterone', 'sucralfate', 'ubrogepant', 'pramipexole', 'calcitriol', 'ipratropium', 'ticagrelor', 'pancrelipase lipase/pancrelipase protease/pancrelipase amylase', 'polymyxin b/trimethoprim', 'bumetanide', 'sodium salts', 'alfuzosin', 'senna/docusate', 'moxifloxacin', 'clotrimazole', 'terbinafine', 'isotretinoin', 'insulin isophane', 'calcium phosphate/cholecalciferol', 'insulin detemir', 'letrozole', 'sodium fluoride', 'acetaminophen/butalbital/caffeine', 'ciclopirox', 'cyproheptadine', 'ethinyl estradiol/norelgestromin', 'desogestrel/ethinyl estradiol', 'chlorhexidine', 'nabumetone', 'lidocaine', 'hydroquinone', 'codeine/guaifenesin', 'dexamethasone/neomycin/polymyxin b', 'polyethylene glycol 3350 with electrolytes', 'penicillin v', 'levalbuterol', 'lactate', 'guanfacine', 'betamethasone', 'fluorouracil', 'beclomethasone', 'loratadine/pseudoephedrine', 'ascorbic acid', 'mycophenolate mofetil', 'olopatadine', 'indomethacin', 'brompheniramine/dextromethorphan/pseudoephedrine', 'benzoyl peroxide', 'ciprofloxacin/dexamethasone', 'phenazopyridine', 'cefuroxime', 'thiamine', 'ethinyl estradiol/norgestrel', 'sulfacetamide/sulfur', 'acetaminophen', 'ibuprofen', 'naproxen sodium', 'aspirin', 'acetaminophen/diphenhydramine', 'loratadine', 'cetirizine', 'fexofenadine', 'diphenhydramine', 'chlorpheniramine', 'loratadine/pseudoephedrine', 'omeprazole', 'esomeprazole', 'lansoprazole', 'famotidine', 'calcium carbonate', 'calcium carbonate/magnesium hydroxide', 'simethicone', 'loperamide', 'bismuth subsalicylate', 'docusate sodium', 'polyethylene glycol 3350', 'bisacodyl', 'sennosides', 'dextromethorphan', 'guaifenesin', 'guaifenesin/dextromethorphan', 'phenylephrine', 'pseudoephedrine', 'acetaminophen/dextromethorphan/phenylephrine', 'doxylamine/acetaminophen/dextromethorphan', 'diphenhydramine (sleep aid)', 'doxylamine succinate', 'melatonin', 'meclizine', 'dimenhydrinate', 'multivitamin adult', 'vitamin D3', 'vitamin C', 'biotin', 'fish oil / omega-3', 'folic acid', 'iron (ferrous sulfate)', 'calcium + vitamin D', 'glucosamine/chondroitin', 'probiotic', 'nicotine lozenge', 'ibuprofen/famotidine', 'naproxen/esomeprazole', 'capsaicin', 'diclofenac sodium 1%', 'lidocaine 4%', 'menthol', 'methyl salicylate', 'magnesium salicylate', 'acetaminophen / caffeine / pyrilamine', 'acetaminophen / aspirin / caffeine', 'ibuprofen sodium', 'naproxen sodium / diphenhydramine', 'acetaminophen / diphenhydramine', 'benzocaine (topical)', 'pramoxine hydrochloride', 'trolamine salicylate', 'lidocaine 0.5% / aloe', 'benzocaine / menthol', 'cetirizine hydrochloride', 'fexofenadine hydrochloride', 'levocetirizine dihydrochloride', 'diphenhydramine hydrochloride', 'chlorpheniramine maleate', 'brompheniramine maleate', 'clemastine fumarate', 'ketotifen fumarate', 'naphazoline hydrochloride', 'olopatadine hydrochloride 0.1%', 'olopatadine hydrochloride 0.2%', 'tetrahydrozoline hydrochloride', 'cromolyn sodium', 'pheniramine maleate / naphazoline', 'azelastine hydrochloride 0.15%', 'cetirizine / pseudoephedrine', 'loratadine / pseudoephedrine', 'fexofenadine / pseudoephedrine', 'tetrahydrozoline / zinc sulfate', 'naphazoline / glycerin', 'triprolidine hydrochloride', 'pyrilamine maleate', 'fluticasone propionate', 'budesonide (nasal)', 'triamcinolone acetonide', 'mometasone furoate (nasal)', 'fluticasone furoate', 'pseudoephedrine hydrochloride', 'phenylephrine hydrochloride', 'oxymetazoline hydrochloride', 'sodium chloride (nasal)', 'epinephrine (inhalation)', 'ephedrine / guaifenesin', 'dextromethorphan hydrobromide', 'acetaminophen / dextromethorphan / doxylamine', 'acetaminophen / dextromethorphan / phenylephrine', 'acetaminophen / pseudoephedrine', 'guaifenesin / pseudoephedrine', 'guaifenesin / dextromethorphan', 'ibuprofen / pseudoephedrine', 'levmetamfetamine', 'propylhexedrine', 'benzyl alcohol', 'dyclonine hydrochloride', 'phenol (liquid)', 'menthol (lozenges)', 'zinc acetate / zinc gluconate', 'homeopathic zinc gluconate', 'chlophedianol hydrochloride', 'dextromethorphan polistirex', 'pseudoephedrine / triprolidine', 'esomeprazole magnesium', 'cimetidine', 'aluminum hydroxide / magnesium hydroxide', 'sodium bicarbonate', 'psyllium husk', 'senna / sennosides', 'magnesium hydroxide', 'magnesium citrate', 'loperamide hydrochloride', 'lactase enzyme', 'alpha-galactosidase', 'glycerin (suppository)', 'polycarbophil', 'wheat dextrin', 'inulin fiber', 'loperamide / simethicone', 'activated charcoal', 'sodium citrate / citric acid', 'magnesium oxide', 'phosphorated carbohydrate solution', 'meclizine hydrochloride', 'ginger root extract', 'sennosides / docusate sodium', 'sodium phosphate', 'mineral oil (enema)', 'attapulgite', 'mineral oil (oral)', 'castor oil', 'docusate calcium', 'hydrocortisone 1%', 'bacitracin / neomycin / polymyxin b', 'bacitracin / polymyxin b', 'clotrimazole (topical)', 'miconazole nitrate', 'terbinafine hydrochloride', 'tolnaftate', 'ketoconazole 1%', 'selenium sulfide 1%', 'pyrithione zinc', 'benzoyl peroxide 10%', 'salicylic acid 2%', 'adapalene 0.1%', 'docosanol 10%', 'permethrin 1%', 'calamine / pramoxine', 'witch hazel (hamamelis virginiana)', 'zinc oxide', 'dimethicone', 'petrolatum (white)', 'benzalkonium chloride / lidocaine', 'neomycin / polymyxin / pramoxine', 'hydrocortisone acetate', 'phenylephrine / mineral oil / petrolatum', 'coal tar', 'sulfur / salicylic acid', 'ketoconazole cream', 'undecylenic acid', 'tolnaftate liquid', 'benzoyl peroxide 4% wash', 'sulfur (topical)', 'resorcinol / sulfur', 'alpha-hydroxy acids (glycolic)', 'urea 10% - 20%', 'ammonium lactate 12%', 'minoxidil 5%', 'pyrethrins / piperonyl butoxide', 'dimethicone (lice)', 'colloidal oatmeal', 'aluminum acetate', 'witch hazel liquid', 'salicylic acid 17%', 'clotrimazole 3-day', 'clotrimazole 7-day', 'tioconazole 1-day', 'carboxymethylcellulose sodium', 'propylene glycol / polyethylene glycol', 'carbamide peroxide (otic)', 'isopropyl alcohol / anhydrous glycerin', 'benzocaine (oral)', 'hydrogen peroxide (oral)', 'mineral oil / petrolatum (ophthalmic)', 'artificial tears (polyvinyl alcohol)', 'brimonidine tartrate 0.025%', 'carbamide peroxide (oral)', 'potassium nitrate', 'sodium fluoride', 'stannous fluoride', 'cetylpyridinium chloride', 'polyethylene glycol / propylene glycol', 'carboxymethylcellulose (high viscosity)', 'mineral oil / white petrolatum (ophthalmic)', 'polyvinyl alcohol / povidone', 'hypromellose', 'sodium chloride hypertonic 5%', 'levonorgestrel 1.5mg', 'norgestrel 0.075mg', 'phenazopyridine hydrochloride', 'nicotine polacrilex', 'nicotine transdermal', 'orlistat 60mg', 'diphenhydramine citrate (sleep)', 'caffeine', 'naloxone hydrochloride', 'cyanocobalamin (oral)', 'ferrous sulfate', 'calcium carbonate / vitamin d3', 'choline salicylate']
...
def restrict_gallery(gallery_emb, gallery_labels, keep_labels):
    ...
    can be confused with -- priority-tier RX currently competes against
    tens of thousands of long-tail RX classes it would never face in a
    "top-500 common drugs" deployment mode."""
...
def evaluate_deployment_modes(rows, gallery_emb, gallery_labels):
    """Two app deployment modes that restrict the search gallery instead of
    always searching the full ~95k-class gallery -- a different, likely
    bigger lever than more training time, since priority-tier RX currently
    competes against tens of thousands of long-tail RX classes a "common
    ...
    500 common drugs, so restricting to priority-only would just make it
    unfindable, not more findable.

    "priority_tier_gallery": app knows "this is a common drug" but not RX
      vs OTC -- gallery restricted to ALL priority-tier classes together.
    "priority_tier_and_category_gallery": app additionally knows RX vs OTC
      (user picked it) -- gallery restricted to just that category's
      priority-tier classes. This is the "ask RX or OTC, browse the rest
      if unsure" idea."""
